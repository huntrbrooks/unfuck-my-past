...
export default function Home() {
  ...
  const todaysEntries = entries.filter((entry) => entry.date === new Date().toLocaleDateString())
    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border bg-card/50 backdrop-blur-sm">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-semibold text-foreground">Mindful Journal</h1>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-6 py-8 max-w-4xl">
        <Card className="mb-8 shadow-lg">
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              ...
              disabled={!currentEntry.trim() || isGeneratingInsights}
              className="w-full"
            >
        ...
        {showInsights && latestInsights.length > 0 && (
          <Card className="mb-8 border-primary/20 bg-primary/5 slide-up">
            <CardHeader>
          ...
          <Card className="text-center py-12">
            <CardContent>
              ...
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Start your mindful journey by writing your first entry. Our AI will provide personalized insights to
                help you reflect and grow.
              </p>
            </CardContent>
          </Card>
        )}
